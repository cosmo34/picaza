...
window.PICAZA_I18N = {
  ...
  strings: {
    fr: {
      ...
      install_android: "Télécharger pour Android",
      install_note:
        "NUMERS iPhone et iPad est sur l’App Store. L’app Mac et l’APK Android se téléchargent ci-dessus.",
      ...
      contact_modal_app: "Application concernée",
      contact_app_placeholder: "Choisir…",
      contact_app_other: "Autre",
    ...
    en: {
      ...
      install_android: "Download for Android",
      install_note:
        "NUMERS for iPhone and iPad is on the App Store. The Mac app and Android APK can be downloaded above.",
      privacy_btn: "Privacy",
      support_btn: "Support",
      ...
      contact_modal_app: "Related application",
      contact_app_placeholder: "Choose…",
      contact_app_other: "Other",
    ...
    es: {
      ...
      install_android: "Descargar para Android",
      install_note:
        "NUMERS para iPhone e iPad está en el App Store. La app Mac y el APK Android se descargan más arriba.",
      ...
      contact_modal_app: "Aplicación concernida",
      contact_app_placeholder: "Elegir…",
      contact_app_other: "Otro",
    ...
    de: {
      ...
      install_android: "Für Android laden",
      install_note:
        "NUMERS für iPhone und iPad ist im App Store. Die Mac-App und die Android-APK können Sie oben herunterladen.",
      ...
      contact_modal_app: "Betroffene App",
      contact_app_placeholder: "Auswählen…",
      contact_app_other: "Andere",
    ...
    it: {
      ...
      install_android: "Scarica per Android",
      install_note:
        "NUMERS per iPhone e iPad è sull’App Store. L’app Mac e l’APK Android si scaricano sopra.",
      privacy_btn: "Privacy",
      ...
      contact_modal_app: "Applicazione interessata",
      contact_app_placeholder: "Scegli…",
      contact_app_other: "Altro",
    ...
    zh: {
      ...
      install_android: "下载 Android 版",
      install_note: "NUMERS 的 iPhone / iPad 版已上架 App Store。Mac 版与 Android APK 可在上方下载。",
      privacy_btn: "隐私",
      support_btn: "支持",
      ...
      contact_modal_app: "相关应用",
      contact_app_placeholder: "请选择…",
      contact_app_other: "其他",
    ...
    ar: {
      ...
      install_android: "تنزيل لنظام Android",
      install_note:
        "NUMERS لـ iPhone و iPad متوفر على App Store. يمكن تنزيل تطبيق Mac وملف Android أعلاه.",
      ...
      contact_modal_app: "التطبيق المعني",
      contact_app_placeholder: "اختر…",
      contact_app_other: "أخرى",
